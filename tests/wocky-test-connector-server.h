...
typedef enum {
  ...
  CONNECTOR_PROBLEM_NO_SESSION       = CONNPROBLEM (10),
  CONNECTOR_PROBLEM_SESSION_FAILED   = CONNPROBLEM (11),
  CONNECTOR_PROBLEM_SESSION_DENIED   = CONNPROBLEM (12),
  CONNECTOR_PROBLEM_SESSION_CONFLICT = CONNPROBLEM (13),
  CONNECTOR_PROBLEM_SESSION_REJECTED = CONNPROBLEM (14),
  CONNECTOR_PROBLEM_SESSION_NONSENSE = CONNPROBLEM (15),
  CONNECTOR_PROBLEM_DIE_SERVER_START = CONNPROBLEM (16),
  CONNECTOR_PROBLEM_DIE_CLIENT_OPEN  = CONNPROBLEM (17),
  CONNECTOR_PROBLEM_DIE_SERVER_OPEN  = CONNPROBLEM (18),
  CONNECTOR_PROBLEM_DIE_FEATURES     = CONNPROBLEM (19),
  CONNECTOR_PROBLEM_DIE_TLS_NEG      = CONNPROBLEM (20),
  CONNECTOR_PROBLEM_XMPP_OTHER_HOST  = CONNPROBLEM (21),
  CONNECTOR_PROBLEM_XMPP_TLS_LOAD    = CONNPROBLEM (22),
  CONNECTOR_PROBLEM_XMPP_BIND_CLASH  = CONNPROBLEM (23),
  CONNECTOR_PROBLEM_XMPP_NO_SESSION  = CONNPROBLEM (24),
} ConnectorProblem;
