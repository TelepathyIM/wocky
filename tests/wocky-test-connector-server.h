...
typedef enum {
  ...
  CONNECTOR_PROBLEM_OLD_SERVER       = CONNPROBLEM (26),
  CONNECTOR_PROBLEM_OLD_AUTH_FEATURE = CONNPROBLEM (27),
  CONNECTOR_PROBLEM_OLD_AUTH_REJECT  = CONNPROBLEM (28),
  CONNECTOR_PROBLEM_OLD_AUTH_BIND    = CONNPROBLEM (29),
  CONNECTOR_PROBLEM_OLD_AUTH_PARTIAL = CONNPROBLEM (30),
  CONNECTOR_PROBLEM_OLD_AUTH_FAILED  = CONNPROBLEM (31),
  CONNECTOR_PROBLEM_OLD_AUTH_STRANGE = CONNPROBLEM (32),
  CONNECTOR_PROBLEM_OLD_AUTH_NIH     = CONNPROBLEM (33),
} ConnectorProblem;
