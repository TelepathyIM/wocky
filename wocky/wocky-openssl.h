...
#ifndef _wocky_openssl_h_
#define _wocky_openssl_h_
...
#define WOCKY_TLS_VERIFY_STRICT  4
#define WOCKY_TLS_VERIFY_NORMAL  2
#define WOCKY_TLS_VERIFY_LENIENT 1
